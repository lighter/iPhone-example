...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reveiveNotification:) name:@"Test" object:nil];
    }
    return self;
}

-(void) reveiveNotification:(NSNotification *) notification
{
